...
//       // partial payload stored in frontend-encrypted blob (you may include other defaults)
//       const payload = {
//         fullName: '',
//         email: data.email,
//         phone: '',
...
//           <button type="button" onClick={handleSubmit(onRegister)}>Quick Register</button>
//         </div>
//       </form>
