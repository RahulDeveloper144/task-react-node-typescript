...
//   id: string;
//   emailHash: string;
//   encrypted: string; // still encrypted with FRONT_KEY
//   createdAt?: string;
// };
...
//   const [students, setStudents] = useState<Array<{ id: string; plain?: PlainStudent; emailHash: string }>>([]);
...
//       <h2>Students</h2>
//       {editing ? (
//         <StudentForm initial={editing.data} id={editing.id} isEditingMode onSaved={onSaved} onCancel={() => setEditing(null)} />
//       ) : (
...
//             <th style={{ borderBottom: '1px solid #ddd', textAlign: 'left' }}>Course</th>
...
//           {students.map(s => (
//             <tr key={s.id}>
//               <td style={{ padding: '8px 4px', borderBottom: '1px solid #f1f1f1' }}>{s.plain?.fullName ?? '—'}</td>
//               <td style={{ padding: '8px 4px', borderBottom: '1px solid #f1f1f1' }}>{s.plain?.email ?? '—'}</td>
//               <td style={{ padding: '8px 4px', borderBottom: '1px solid #f1f1f1' }}>{s.plain?.course ?? '—'}</td>
...
//             </tr>
//           ))}
//           {students.length === 0 && !loading && <tr><td colSpan={4}>No students yet</td></tr>}
//         </tbody>
//       </table>
//     </div>
//   );
